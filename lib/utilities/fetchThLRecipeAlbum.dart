...
import 'package:login/Modals/TBRecipe.dart';
...
Future<ThLRecipe> fetchThLRecipeAlbum() async {
  final response = await http
      .get(Uri.parse('https://api.spoonacular.com/recipes/complexSearch?query=${lunchMenu[3]}&number=1&apiKey=fea1e0484037450bb541f4e54a1fc370'));
  ...
  if (response.statusCode == 200) {
    ...
    return ThLRecipe.fromJson(jsonDecode(response_2.body));
