...
import '../utilities/update_likes.dart';
...
class MyRecipePage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MyRecipePage> createState() => _MyRecipePageState();
}

class _MyRecipePageState extends ConsumerState<MyRecipePage> {
  ...
  void initState() {
    super.initState();
    futureAlbum = fetchRecipe(widget.recipeName);
    isRecipeLiked(widget.recipeName).then((liked) {
  ...
  Widget build(BuildContext context) {
    ...
    const TextStyle styleHeader = TextStyle(fontSize: 24);

    const TextStyle styleInfo = TextStyle(fontSize: 20);

    const TextStyle styleMeasures = TextStyle(fontSize: 16);
                  ...
                  if (snapshot.hasData) {
                    return ListView(children: <Widget>[
                      Container(
                          ...
                          padding:
                              const EdgeInsets.fromLTRB(00.0, 10.0, 00.0, 10.0),
                      ...
                      Center(
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              Column(children: [
                                const Text("Calories", style: styleInfo),
                                const Text("Kcal", style: styleMeasures),
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    snapshot.data!.calories.round().toString(),
                              ...
                              Column(children: [
                                const Text("Protein", style: styleInfo),
                                const Text("g", style: styleMeasures),
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    snapshot.data!.protein.round().toString(),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                              ]),
                              ...
                              Column(children: <Widget>[
                                const Text("Fat", style: styleInfo),
                                const Text("g", style: styleMeasures),
                                const SizedBox(height: 8),
                                Container(
                                  margin: const EdgeInsets.fromLTRB(
                                  ...
                                  child: Text(
                                    snapshot.data!.fat.round().toString(),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                              ]),
                      ...
                      Container(
                          margin:
                              const EdgeInsets.fromLTRB(40.0, 00.0, 36.0, 00.0),
                          padding:
                              const EdgeInsets.fromLTRB(20.0, 20.0, 20.0, 20.0),
                          child: Text(
                            "Time:${snapshot.data!.time}min",
                            textAlign: TextAlign.right,
                            style: styleMeasures,
                          )),
                      Container(
                        ...
                        margin:
                            const EdgeInsets.fromLTRB(40.0, 00.0, 20.0, 00.0),
                        padding:
                      ...
                      Container(
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return Text(
                                    snapshot.data!.ingredientName[index]
                                        .ingredientDetails
                                        .toString(),
                                    style: styleMeasures,
                                    textAlign: TextAlign.center);
                      ...
                      Container(
                          margin:
                              const EdgeInsets.fromLTRB(4.0, 00.0, 4.0, 00.0),
                          padding:
                                ...
                                child: Column(children: [
                                  ...
                                  Container(
                                      child: ListView.builder(
                                          shrinkWrap: true,
                                          itemCount:
                                              snapshot.data!.diets.length,
                                          itemBuilder: (BuildContext context,
                                              int index) {
                                            return Text(
                                                '-${snapshot.data!.diets[index]}',
                                                style: styleMeasures,
                                                textAlign: TextAlign.center);
                                          })),
                                ])),
