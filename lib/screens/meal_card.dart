...
class _MealCardState extends State<MealCard>
  ...
  (String, String) _queueAndField() {
    switch (widget.mealType) {
      case 'breakfast':
        return ('queue_breakfast', 'breakfastMenu');
      case 'lunch':
        return ('queue_lunch', 'lunchMenu');
      default:
        return ('queue_dinner', 'dinnerMenu');
    }
  }
          ...
          default:
            ...
            return Column(children: <Widget>[
              ...
              GestureDetector(
                  ...
                  child: Container(
                      margin: const EdgeInsets.fromLTRB(4.0, 10.0, 4.0, 10.0),
                      ...
                      child: Column(children: [
                        ...
                        Row(
                          ...
                          children: [
                            Column(children: [
                              const Text("Servings", style: styleType),
                              Container(
                                decoration: const BoxDecoration(
                                  border: Border(
                                    bottom: BorderSide(
                            ...
                            Column(
                              children: [
                                const Text("Rating", style: styleType),
                                Container(
                                  decoration: const BoxDecoration(
                                    border: Border(
                                      bottom: BorderSide(
                                  ...
                                  child: Text(
                                      snapshot.data!.score.round().toString()),
                                ),
                              ],
                            ),
                            const SizedBox(width: 24),
                            Column(
                              children: [
                                const Text("HScore", style: styleType),
                                Container(
                                  decoration: const BoxDecoration(
                                    border: Border(
                                      bottom: BorderSide(
                                  ...
                                  child: Text(snapshot.data!.healthScore
                                      .round()
                                      .toString()),
                                ),
                              ],
                            ...
                            onPressed: () async {
                              final confirmed = await showDialog<bool>(
                                ...
                                builder: (context) => AlertDialog(
                                  ...
                                  content: const Text(
                                      'This will replace it with a different recipe.'),
                                  actions: [
                                    TextButton(
                                        onPressed: () =>
                              ...
                              final newTitle = await swapMeal(queueCol,
                                  menuField, widget.index, widget.cap);
                              ...
                              if (newTitle != null) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                      content:
                                          Text('No more recipes to swap to')),
                                );
                              }
                            },
                          ),
